    ...
    <div class="container relative py-16 md:py-24 lg:py-28">
      <div class="max-w-3xl">
        <div class="inline-flex items-center gap-2 text-[11px] font-heading font-semibold text-primary uppercase tracking-[0.12em] mb-4 px-3 py-1.5 rounded-full bg-primary/8 border border-primary/12">
          ${svgSized(SVG.shield, 'w-3.5 h-3.5')}
...
/* Helper: replace the size class in an SVG string */
function svgSized(svgStr, sizeClass) {
  return svgStr.replace(/class="w-[\d.]+ h-[\d.]+/, `class="${sizeClass}`);
}
...
const SVG = {
  ...
  sparkles: '<svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"/><path d="M20 3v4"/><path d="M22 5h-4"/></svg>',
  ...
  checkCircle: '<svg class="w-3.5 h-3.5 text-success shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>',
  xCircle: '<svg class="w-3.5 h-3.5 text-muted-foreground/30 shrink-0 mt-0.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>',
  ...
  chevronRight: '<svg class="w-4 h-4 text-muted-foreground/30" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg>',
  award: '<svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89 17 22l-5-3-5 3 1.523-9.11"/></svg>',
  barChart: '<svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="20" x2="12" y2="10"/><line x1="18" y1="20" x2="18" y2="4"/><line x1="6" y1="20" x2="6" y2="16"/></svg>',
  layers: '<svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>',
  ...
  helpCircle: '<svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>',
  ...
  heart: '<svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>',
...
const FLAGSHIP_META = {
  ...
  '/tevu-kontrole': {
    ...
    jumpLinks: [
      ...
      { href: '#pagal-amziu', label: 'Pagal amžių', svg: 'users' },
      { href: '#kam-tinka', label: 'Kam tinka', svg: 'layers' },
      { href: '#kaip-pasirinkti', label: 'Kaip pasirinkti', svg: 'shield' },
      { href: '#duk', label: 'DUK', svg: 'helpCircle' },
    ],
    useCases: [
      { title: 'Visapusiškas sprendimas', shortWhy: 'Plačiausias funkcijų rinkinys: ekrano laikas, GPS, geofencing, turinio filtras, panikos mygtukas ir YouTube stebėjimas viename.', matchKey: 'Qustodio', tag: '🥇 Nr. 1' },
      { title: 'Šeima su paaugliais', shortWhy: 'Lankstūs apribojimai pagal amžių, paieškos stebėjimas ir neinvazyvus požiūris. Dažnai įeina į Norton 360 paketą.', matchKey: 'Norton', tag: 'Paaugliai' },
      { title: 'Socialinių tinklų priežiūra', shortWhy: 'AI technologija stebi 30+ platformų ir perspėja tik apie tikrai pavojingą turinį — patyčias, depresiją, smurtą.', matchKey: 'Bark', tag: 'Soc. tinklai' },
      { title: 'Geriausias nemokamas', shortWhy: 'Visiškai nemokama programa su programėlių patvirtinimu, ekrano laiku ir SafeSearch.', matchKey: 'Google', tag: 'Nemokamai' },
      { title: 'Geriausia kaina', shortWhy: 'Pilnai funkcionalus sprendimas su YouTube filtravimu ir lietuviška pagalba už prieinamą kainą.', matchKey: 'Kaspersky', tag: 'Vertė' },
    ],
    buyerGuide: [
      { q: 'Koks vaiko amžius?', a: 'Jaunesniems vaikams (6–10 m.) pakanka paprastesnių įrankių: Google Family Link ar Apple Screen Time. Paaugliams (11–16 m.) — Qustodio ar Bark su socialinių tinklų stebėjimu.' },
      { q: 'Ar reikia GPS sekimo?', a: 'Qustodio, Norton Family ir Kaspersky Safe Kids siūlo GPS su geofencing — gausite pranešimą, kai vaikas paliks saugią zoną.' },
      { q: 'Ar svarbi socialinių tinklų priežiūra?', a: 'Bark stebi 30+ platformų (TikTok, Instagram, Snapchat) su AI analize. Qustodio stebi tik YouTube.' },
      { q: 'Kokius įrenginius naudojate?', a: 'Qustodio ir Bark palaiko daugiausiai platformų (Android, iOS, Windows, Mac). Google Family Link — tik Android.' },
      { q: 'Koks biudžetas?', a: 'Nemokamai: Google Family Link (Android) arba Apple Screen Time (iOS). Premium: Qustodio (nuo 3.58 €/mėn.).' },
      { q: 'Ar norite griežtos kontrolės ar stebėjimo?', a: 'Griežtam blokavimui — Qustodio ar Norton Family. Stebėjimui ir perspėjimams — Bark (neblokuoja, tik perspėja).' },
    ],
    ageGroups: [
      { age: '4–7 metai', subtitle: 'Pirmieji žingsniai', color: 'success', features: ['Griežtas turinio filtravimas', 'Programėlių patvirtinimas prieš diegimą', 'Trumpi ekrano laiko limitai', 'Paprasta sąsaja tėvams'], recommendation: '→ Google Family Link arba Kaspersky Safe Kids' },
      { age: '8–12 metai', subtitle: 'Aktyvus naršymas', color: 'primary', featured: true, features: ['Turinio filtras + YouTube stebėjimas', 'GPS sekimas ir geofencing', 'Ekrano laiko grafikai (mokykla/namai)', 'Ataskaitos apie veiklą'], recommendation: '→ Qustodio arba Norton Family' },
      { age: '13–17 metų', subtitle: 'Paaugliai', color: 'muted', features: ['Socialinių tinklų AI stebėjimas', 'Perspėjimai apie pavojingą turinį', 'Mažiau invazyvus požiūris', 'Lankstūs, amžiui pritaikyti apribojimai'], recommendation: '→ Bark arba Norton Family' },
    ],
    methodology: [
      { title: 'Funkcijų apimtis', desc: 'Ekrano laikas, turinio filtras, GPS, geofencing, socialinių tinklų stebėjimas — kiek funkcijų siūloma ir kokia jų kokybė.' },
      { title: 'Naudojimo paprastumas', desc: 'Diegimo greitis, sąsajos aiškumas tiek tėvams, tiek vaikams. Ar reikia techninių žinių?' },
      { title: 'Platformų palaikymas', desc: 'Android, iOS, Windows, Mac, Chromebook — kiek platformų palaikoma ir ar visos funkcijos veikia visur.' },
      { title: 'Privatumas ir etika', desc: 'Ar programa gerbia vaiko privatumą? Kokius duomenis renka? Ar leidžia skaidrų naudojimą?' },
      { title: 'Kaina ir vertė', desc: 'Nemokamų ir mokamų versijų funkcijų palyginimas. Kiek įrenginių galima pridėti?' },
    ...
    pillarFaq: [
      ...
      { q: 'Ar vaikai gali apeiti tėvų kontrolę?', a: 'Paaugliai gali bandyti, bet kokybiškos programos (Qustodio, Norton Family) turi apsaugą nuo pašalinimo ir VPN apėjimo.' },
      { q: 'Ar tėvų kontrolė veikia su VPN?', a: 'Kai kurios programos (Qustodio) gali blokuoti VPN. Bark veikia per įrenginio lygio stebėjimą, todėl VPN neturi įtakos.' },
      { q: 'Ar nemokamos tėvų kontrolės programos veikia?', a: 'Google Family Link ir Apple Screen Time suteikia bazinę kontrolę nemokamai, bet trūksta pažangių funkcijų kaip GPS, geofencing ir socialinių tinklų stebėjimas.' },
      { q: 'Kaip kalbėti su vaiku apie tėvų kontrolę?', a: 'Specialistai rekomenduoja atvirą pokalbį: paaiškinkite taisykles, priežastis ir leiskite vaikui dalyvauti nustatant ribas.' },
    ],
  },
  '/tevu-kontrole/vaiko-telefone': {
  ...
  '/slaptazodziu-saugumas': {
    ...
    heroTitle: 'Slaptažodžių saugumas: kaip apsaugoti savo paskyras',
    ...
    stats: [
      ...
      { value: '15+', label: 'Simbolių — NIST 2026 rekomenduojamas minimumas' },
      { value: '70%', label: 'Žmonių naudoja tuos pačius slaptažodžius' },
      { value: '2FA', label: 'Sumažina paskyros perėmimo riziką 99%' },
    ],
    strengthExamples: [
    ...
    hubFaq: [
      ...
      { q: 'Ar verta naudoti slaptažodžių tvarkyklę?', a: 'Taip, tai vienas svarbiausių saugumo įrankių. Slaptažodžių tvarkyklė sukuria unikalius, sudėtingus slaptažodžius kiekvienai paskyrai ir saugiai juos saugo.' },
      { q: 'Kaip dažnai reikia keisti slaptažodžius?', a: 'Pagal NIST 2026 gaires, reguliarus slaptažodžio keitimas neberekomendojamas. Keiskite tik tada, kai įtariate kompromitavimą ar gavote pranešimą apie nutekėjimą.' },
      { q: 'Kas yra dviejų veiksnių autentifikacija (2FA)?', a: '2FA prideda papildomą saugumo sluoksnį — be slaptažodžio reikia patvirtinimo iš kito įrenginio. Net jei kas nors sužinos jūsų slaptažodį, be 2FA kodo prisijungti negalės.' },
  ...
  '/slaptazodziu-saugumas/slaptazodziu-tvarkykles': {
    ...
    jumpLinks: [
      { href: '#top-5', label: 'Top 5', svg: 'award' },
      { href: '#palyginimas', label: 'Palyginimas', svg: 'barChart' },
      { href: '#pagal-poreiki', label: 'Pagal poreikį', svg: 'layers' },
      { href: '#nemokama-vs-mokama', label: 'Nemokama vs mokama', svg: 'zap' },
      { href: '#kaip-pasirinkti', label: 'Kaip pasirinkti', svg: 'shield' },
      { href: '#duk', label: 'DUK', svg: 'helpCircle' },
    ],
    useCases: [
      { title: 'Geriausia visapusiškai', shortWhy: 'Stipriausios saugumo funkcijos, Watchtower auditas, passkey ir Travel Mode.', matchKey: '1Password', tag: '🥇 Nr. 1' },
      { title: 'Geriausia nemokama', shortWhy: 'Pilnai nemokama, atviro kodo, audituota, neriboti slaptažodžiai visuose įrenginiuose.', matchKey: 'Bitwarden', tag: 'Nemokama' },
      { title: 'Geriausia privatumui', shortWhy: 'Šveicarijos jurisdikcija, atviras kodas, el. pašto maskavimas, nemokama sinchronizacija.', matchKey: 'Proton', tag: 'Privatumas' },
      { title: 'Geriausia šeimoms', shortWhy: 'Šeimos planas iki 5 narių, saugus dalinimasis ir centralizuotas valdymas.', matchKey: '1Password', tag: 'Šeimoms' },
      { title: 'Paprasčiausia naudoti', shortWhy: 'Intuityvi sąsaja, XChaCha20 šifravimas, Data Breach Scanner.', matchKey: 'NordPass', tag: 'Lengva' },
    ],
    freeVsPaid: {
      freeTitle: 'Nemokama versija',
      freePrice: '0 €',
      freeItems: [
      ...
      freeNote: 'Tinka: individualiems naudotojams, kuriems užtenka bazinių funkcijų.',
      paidTitle: 'Mokama versija',
      paidPrice: '1–5 $/mėn.',
      paidItems: [
    ...
    buyerGuide: [
      { q: 'Kiek įrenginių naudojate?', a: 'Vienam įrenginiui — Bitwarden ar Proton Pass nemokama versija. Keliems — rinkitės tvarkyklę su neribota sinchronizacija.' },
      { q: 'Ar reikia šeimos plano?', a: 'Šeimoms geriausia — 1Password Family (iki 5 narių, privatūs ir bendri seifai). Bitwarden Organizations taip pat tinka.' },
      { q: 'Ar svarbus privatumas?', a: 'Jei privatumas prioritetas — Proton Pass (Šveicarija, atviras kodas) arba Bitwarden (atviras kodas, self-hosting).' },
      { q: 'Kokia kaina priimtina?', a: '0 € — Bitwarden, Proton Pass. 1–3 $/mėn. — NordPass, RoboForm. 3–5 $/mėn. — 1Password.' },
      { q: 'Ar reikia passkey palaikymo?', a: 'Passkeys — ateities standartas. 1Password, Bitwarden, NordPass ir Proton Pass jau palaiko. RoboForm dar ne.' },
      { q: 'Ar norite self-hosting?', a: 'Jei norite pilnos kontrolės — Bitwarden vienintelė populiari tvarkyklė, leidžianti saugoti duomenis savo serveryje.' },
    ],
    buyerGuideSummary: 'Jei jums reikia tik bazinės slaptažodžių saugyklos — <strong>Bitwarden</strong> nemokama versija yra geriausias pasirinkimas. Jei norite premium funkcijų ir šeimos plano — <strong>1Password</strong>. Jei svarbiausias privatumas — <strong>Proton Pass</strong>.',
    pillarFaq: [
      { q: 'Kas yra slaptažodžių tvarkyklė ir kam ji reikalinga?', a: 'Slaptažodžių tvarkyklė — programa, kuri saugiai saugo visus jūsų slaptažodžius vienoje šifruotoje saugykloje. Jums tereikia atsiminti vieną pagrindinį slaptažodį.' },
      { q: 'Ar nemokamos slaptažodžių tvarkyklės yra saugios?', a: 'Taip, patikimų gamintojų nemokamos versijos (Bitwarden, NordPass, Proton Pass) naudoja tokį patį šifravimą kaip ir mokamos.' },
      { q: 'Kuo slaptažodžių tvarkyklė geresnė už naršyklės saugyklą?', a: 'Dedikuota tvarkyklė veikia visose platformose, turi master password, slaptažodžių generatorių ir stebi duomenų nutekėjimus.' },
      { q: 'Ką daryti, jei pamiršiu master password?', a: 'Dauguma tvarkyklių turi atkūrimo mechanizmus: atsarginiai kodai, biometrinė prieiga, šeimos narių atkūrimas.' },
      { q: 'Ar verta mokėti už slaptažodžių tvarkyklę?', a: 'Jei turite 1–2 įrenginius — nemokama gali pakakti. Mokama verta jei reikia šeimos plano, pažangaus nutekėjimų stebėjimo ar YubiKey.' },
      { q: 'Ar slaptažodžių tvarkyklė apsaugo nuo phishing?', a: 'Iš dalies — tvarkyklė automatiškai užpildo slaptažodžius tik tikroje svetainėje, kas padeda atpažinti suklastotus puslapius.' },
    ],
    methodology: [
      { title: 'Šifravimo stiprumas', desc: 'AES-256, XChaCha20, Argon2 — vertinamas šifravimo algoritmas ir jo implementacija.' },
      { title: 'Funkcijų apimtis', desc: 'Passkeys, 2FA, saugumo auditas, dalinimasis, šeimos planai ir nutekėjimų stebėjimas.' },
      { title: 'Privatumas', desc: 'Zero-knowledge architektūra, jurisdikcija, atviras kodas ir nepriklausomi auditai.' },
      { title: 'Naudojimo paprastumas', desc: 'Sąsajos aiškumas, autofill kokybė, onboarding greitis ir platformų palaikymas.' },
      { title: 'Kainos ir vertės santykis', desc: 'Nemokamos versijos stiprumas, mokamų planų kaina ir ką gaunate už pinigus.' },
