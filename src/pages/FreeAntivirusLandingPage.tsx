...
/* ── Helpers (reused from AntivirusLandingPage) ── */
      ...
      <div className="container py-8 max-w-5xl mx-auto">
        ...
        <section className="mb-8">
          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mb-4">
            <span className="chip-success"><Zap className="w-3 h-3" />100% nemokamos</span>
        ...
        <section id="mokama-vs-nemokama" className="mb-16 scroll-mt-20">
          <SectionHeading label="Svarbus klausimas" title="Ar tikrai pakanka nemokamos antivirusinės?" subtitle="Trumpas atsakymas — priklauso nuo jūsų situacijos." className="mb-5" />
        ...
        <section id="kaip-pasirinkti" className="mb-16 scroll-mt-20">
          <SectionHeading label="Sprendimo gidas" title="Kaip pasirinkti nemokamą antivirusinę" subtitle="Atsakykite į šiuos klausimus — ir bus aišku, kuri nemokama programa jums tinka geriausiai." className="mb-5" />
